...
module.exports = async(conn, msg, m, setting, store, welcome) => {
	try {
		...
		const buttonsDefault = [
			...
			{ quickReplyButton: { displayText: `Salam`, id: `${prefix}assalamualaikum` } }
		]
		...
		switch(command) {
            ...
            case prefix+'hai':
            case prefix+'0':
			    reply(`Silahkan pilih menu dibawah ini
...
*_Silahkan Pilih salah satu_*
*_Angka di atas contoh : .1_*`)
			    break
            case prefix+'1':
			    reply(`*── 「 SEWA BOTZ 」 ──*
...
*TF - SEND LINK - MASUK - DONE*`)
			    break
            case prefix+'2':
                reply(`https://i.ibb.co/88rmZ0d/Qris.jpg
             *Scan*  👆  
           
        *TF - SEND LINK - MASUK - DONE*`)
                break
            case prefix+'3':
			    reply(`*Terima kasih atas pesan Anda. Kami sedang tidak ada saat ini, Admin akan merespons secepat mungkin.*`)
			    break
            case prefix+'4':
			    reply(`*Ss Bukti*`)
			    break
			...
			case prefix+'✧': case prefix+'✧': case prefix+'✧':
